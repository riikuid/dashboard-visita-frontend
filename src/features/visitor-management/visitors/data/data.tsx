...
export const visitorStatuses = [
  ...
  {
    value: 'REGISTERED_VISITOR',
    label: 'Registered Visitor',
    icon: null,
  },
  {
    value: 'VISIT_APPLICATION',
  ...
  {
    value: 'PARTIAL_OVERLIMIT_ON_CHECKPOINT',
    label: 'Partial Overlimit On Checkpoint',
    icon: null,
  },
  {
    value: 'FULL_OVERLIMIT_ON_CHECKPOINT',
    label: 'Full Overlimit On Checkpoint',
    icon: null,
  },
  {
    value: 'PARTIAL_OUT_OF_AREA',
    label: 'Partial Out Of Area',
    icon: null,
  },
  {
    value: 'FULL_OUT_OF_AREA',
