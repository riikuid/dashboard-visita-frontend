...
import { cardRfids } from "./data/data"
    ...
    <CardRfidProvider>
      ...
      <Main>
        <div className="mb-2 flex items-center justify-between space-y-2 flex-wrap gap-x-4">
          <div>
            <h2 className="text-2xl font-bold tracking-tight">RFID Cards</h2>
            <p className="text-muted-foreground">Manage your RFID cards for access control</p>
          </div>
          <CardRfidPrimaryButtons />
        </div>
        <div className="-mx-4 flex-1 overflow-auto px-4 py-1 lg:flex-row lg:space-x-12 lg:space-y-0">
          <DataTable data={cardRfids} columns={columns} />
        </div>
      </Main>
